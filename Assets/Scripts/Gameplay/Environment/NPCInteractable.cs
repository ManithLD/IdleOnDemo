...
{
    /// <summary>
    /// Handles click-based NPC quest turn-ins while the player is inside the NPC trigger range.
    /// </summary>
    ...
    public sealed class NPCInteractable : MonoBehaviour
    {
        ...
        private void TryInteract()
        {
            ...
            if (questManager == null || questManager.ActiveQuest != targetQuest)
            {
                return;
            }
